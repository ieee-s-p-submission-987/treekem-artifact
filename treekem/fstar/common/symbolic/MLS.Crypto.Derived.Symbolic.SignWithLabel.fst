...
let mk_global_mls_sign_pred_later tagged_local_preds tr1 tr2 sk_usg msg =
  ...
  mk_global_fun_eq params (mk_dependent_tagged_local_funs tagged_local_preds) (tr1, sk_usg, msg);
  mk_global_fun_eq params (mk_dependent_tagged_local_funs tagged_local_preds) (tr2, sk_usg, msg);
  parse_wf_lemma (sign_content_nt bytes) (bytes_well_formed tr1) msg;
  introduce forall tag_set lpred content. bytes_well_formed tr1 content /\ params.apply_local_fun lpred (tr1, sk_usg, content) ==> params.apply_local_fun #tag_set lpred (tr2, sk_usg, content) with (
