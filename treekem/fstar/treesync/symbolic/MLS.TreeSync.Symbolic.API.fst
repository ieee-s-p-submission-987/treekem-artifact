...
let external_path_has_event_pre #tkt #l #li leaf_node_has_event_pred group_has_event_pred tr prin t p group_id =
  ...
  Success? (external_path_to_path_nosig t p) /\ (
    ...
    path_to_tree_list_pre (tree_event_pre tr group_has_event_pred prin group_id li) t auth_p ()
  )
...
let trigger_external_path_events #tkt #l #li prin t p group_id =
  ...
  guard (li < pow2 32);*?
  guard (Success? (external_path_to_path_nosig t p));*?
  ...
  trigger_tree_list_event prin group_id li (path_to_tree_list t auth_p);*
  return (Some ())
...
let trigger_external_path_events_proof #invs #tkt #l #li leaf_node_has_event_pred group_has_event_pred prin t p group_id tr =
  ...
  path_to_tree_list_pre_weaken (tree_event_pre tr_in group_has_event_pred prin group_id li) (tree_event_pre tr group_has_event_pred prin group_id li) t auth_p;
  path_to_tree_list_pre_lemma (tree_event_pre tr group_has_event_pred prin group_id li) t auth_p;
