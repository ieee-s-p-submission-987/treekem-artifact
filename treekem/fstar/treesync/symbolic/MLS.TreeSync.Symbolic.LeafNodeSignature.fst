...
let parent_hash_implies_event #ci #tkt #l #i tr group_id t authentifier_token =
  ...
  introduce ((leaf_node_sign_pred tkt).pred tr (mk_mls_sigkey_usage authentifier) ln_tbs_bytes) ==> tree_has_event authentifier tr group_id authentifier_li (|l, i, (canonicalize t authentifier_li)|)
  with _. (
